...
class TableArticle extends Table {
	...
	public function __construct()
	{
		...
		$this->_search = "SELECT *, DATE_FORMAT(dateCreation, ' %d/%m/%Y à %H:%i') AS dateInscriptionFormatee FROM article WHERE nomRubrique = :nomRubrique AND (titre LIKE :test OR infos LIKE :test OR emailUtilisateur LIKE :test) ORDER BY dateCreation DESC";
	}
